            ...
            <tbody>
              ...
              <tr>
               ...
               <td><?php echo $cdata->name; ?></td>
                ...
                <td class="view-delete"><a href="{{url('/sbooking-history-detail/'.$data->id)}}"><svg width="21" height="14" viewBox="0 0 21 14" fill="none" xmlns="http://www.w3.org/2000/svg">
