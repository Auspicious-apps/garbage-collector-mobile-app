<main class="content-main-block">
    ...
    <section class="income-block">
      ...
      <div class="earning-list">
        <div class="earning-list-items">
          <h2>52</h2>
          <p>Total Supplier User’s</p>
        </div>
        <div class="earning-list-items">
          <h2>105</h2>
          <p>Total Collector User’s</p>
        </div>
        <div class="earning-list-items">
          <h2>12</h2>
          <p>New Register Today</p>
        </div>
        <div class="earning-list-items">
          <h2>€ 89.00</h2>
          <p>Today Income</p>
    ...
    <section class="activities-details">
      <h3 class="activity-heading">Recent Activities</h3>
      ...
      <table>
        ...
        <tr>
          ...
          <td>Cordell Hirthe</td>
          <td>Job Completed</td>
          <td>11:30 AM on 22-04-2023</td>
          <td>2806 Simpson Street, California</td>
        </tr>
        <tr>
          <td>#2251</td>
