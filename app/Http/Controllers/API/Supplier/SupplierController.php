...
class SupplierController extends Controller
{
    ...
    { 
            ...
            $validator = Validator::make($request->all(), [ 
               ...
               // 'address_line2' => 'required',
                ...
                'city' => 'required',
                'zip_code' => 'required|min:6|max:8',
                'phone_number' => 'required|min:10|max:11',
               // 'image' => 'mimes:jpeg,png,jpg,gif',
                 'user_type' => 'in:supplier,collector'
            ...
            else 
            {
              ...
              }elseif($request->user_type=='collector'){
    ...
    {  
        ...
        $messages=array(
            ...
            'confirm_password.required' => 'Please enter conform Password .',
